      ...
      <section className="py-16 bg-[#fafafa] dark:bg-gray-950">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-gray-900 border border-[#e8e8e8] dark:border-gray-700 rounded-xl p-8 space-y-8 text-[#605f5f] dark:text-gray-300">
            <div>
              <h2 className="text-xl font-bold text-[#2b2b2b] dark:text-gray-100 mb-3">Collection of Personal Information</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#2b2b2b] dark:text-gray-100 mb-3">Use of Information</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#2b2b2b] dark:text-gray-100 mb-3">Sharing of Information</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#2b2b2b] dark:text-gray-100 mb-3">Changes to This Policy</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#2b2b2b] dark:text-gray-100 mb-3">Contacting Us</h2>
