            ...
            {brochures.map((b, i) => (
              <FadeIn key={b.slug} delay={i * 0.05}>
                <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden hover:-translate-y-1 hover:shadow-xl transition-all duration-300 group">
                  <div className="relative h-20 bg-[#fafafa] dark:bg-gray-800">
                    <Image src={b.img} alt={b.name} fill sizes="(min-width: 1024px) 17vw, (min-width: 768px) 33vw, 50vw" className="object-cover" style={{ filter: "contrast(1.1) brightness(1.02)" }} />
                  </div>
                  <div className="p-3">
